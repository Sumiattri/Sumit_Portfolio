    ...
    <div className={` ${darkMode ? "dark" : ""} relative `}>
      <div className="  h-[547px]  sm:-mt-[164px] -mt-[220px] pt-[124px] bg-[#9FD3EE]  dark:bg-gradient-to-b from-[#111B27] to-[#2f4a5b] relative  overflow-clip   ">
        <div className=" relative flex flex-col items-center justify-end overflow-hidden ">
          ...
          >
            <path
              className="dark:fill-[#111D2B] fill-[#B1DFF5]/90"
            ...
            ></path>
            <path
              className="dark:fill-[#0E1620] fill-[#DDEEF8] "
          ...
          <div className=" absolute scale-[0.88] sm:ml-0 ml-[500px]">
            ...
            >
              <path
                className="dark:fill-[#0D0F12] fill-white "
      ...
      <div
        className={` ${
          darkMode ? "dark" : ""
        } w-full relative  z-99 sm:-mt-40 -mt-48 `}
      >
        <div className="max-w-[1020px] sm:px-[40px] pl-[20px] pr-[40px]  mx-auto dark:text-white text-black  h-30   z-110">
