  ...
  return (
    <div
      className={`w-screen md:h-[80vh] sm:h-[90vh] max-h-[1120px] h-auto relative  sm:-mt-30 -mt-23  ${
        darkMode ? "dark" : ""
      } dark:bg-gradient-to-b from-[#0E0F12] to-[#14181C]/98 bg-[#9FD3EE]   overflow-hidden flex    `}
    >
      <div className=" h-full  w-[100%] mx-auto max-w-[62rem]  z-3 relative  md:pt-[200px] sm:pt-[300px] pt-[340px] lg:px-20 sm:px-10  ">
        <div className="sm:mx-0 mx-6 relative z-10 pb-15">
          <h1 className="text-6xl  dark:text-white text-black font-[font4] ">
            <span className="sm:inline block sm:pb-0 pb-5">Hey,</span>{" "}
            <span className="">I'm Sumit.</span>
          </h1>
          <div className="dark:text-white text-black font-[font3]  sm:text-[18px] text-[20px] lg:w-[500px] w-[450px]  max-w-[100%] sm:pt-5 pt-5">
      ...
      >
        <path
          className="dark:fill-[#262B31] fill-[#DDEFF8]"
          // fill="#262B31"
        ...
        ></path>
        <path
          className="dark:fill-[#1C2127] fill-[#B0DEF4]"
